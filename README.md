...
1. use this repo as a template when creating your own.
  - Alternatively, you can also just copy the files to the base-dir and move your app into `App/src`
...
Secondly, the `Caddyfile` tells caddy what to do. in this case, just serve the contents of the `App/src` directory statically.